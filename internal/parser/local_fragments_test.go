...
func getTestFragments() (globalFragments, localFragments []Fragment) {
	...
	return globalFragments, localFragments
}

func TestCombineFragments_DefaultBehavior(t *testing.T) {
	globalFragments, localFragments := getTestFragments()
...
func TestCombineFragments_NoLocalOverride(t *testing.T) {
	globalFragments, localFragments := getTestFragments()
...
func TestCombineFragments_EmptyFragments(t *testing.T) {
	globalFragments, localFragments := getTestFragments()
